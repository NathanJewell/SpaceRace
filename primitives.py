...
def circle_verts(x, y, resolution, radius):
...
def circle(x, y, resolution, radius, color, batch, group=None):
    points = circle_verts(x, y, resolution, radius)
...
def rect(TLx, TLy, BRx, BRy, color, batch, group=None):
    batch.add(4, pyglet.gl.GL_QUADS, group, ('v2i', (TLx, TLy, TLx, BRy, BRx, BRy, BRx, TLy)), ('c4B', (color*(4))))
